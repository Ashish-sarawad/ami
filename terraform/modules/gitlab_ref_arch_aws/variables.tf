...
variable "bastion_disk_encrypt" {
  type    = bool
  default = null
}
variable "bastion_disk_delete_on_termination" {
  type    = bool
  default = true
}
variable "bastion_disk_kms_key_arn" {
  type    = string
  default = null
}
variable "bastion_data_disks" {
  type    = any
  default = []
}
variable "bastion_iam_instance_policy_arns" {
  type    = list(string)
  default = []
}
